  ...
  return (
    <>
      <div className="flex flex-col">
        <div
          className={`flex ${style.title} w-full justify-center items-center mt-3`}
        >
          Sign in to Continue
        </div>
          ...
          <form onSubmit={handleSubmit} className="w-10/12 ">
            ...
            <div className="flex flex-col justify-center items-center mt-4">
              <input
                type="submit"
                value={"SignIn"}
                className={`${style.button} w-fit px-6  font-[600] font-Poppins p-1.5 `}
              />
            </div>
            <div
            ...
            <div className="flex w-full justify-center items-center mt-4">
              ...
              <p className="px-2 text-[12px] text-white dark:text-white">
                Or Sign with
              </p>
              <hr className="w-[25%] 800px:w-[35%] " />
            </div>
              ...
              <div className="flex items-center justify-between 800px:justify-evenly w-full">
                ...
                <button className="flex items-center bg-white dark:bg-gray-900 border border-gray-300 rounded-lg shadow-md px-4 py-1.5 text-sm font-medium text-gray-800 dark:text-white hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                  ...
                  >
                    ...
                    <desc>Created for LMS Panel</desc> <defs> </defs>
                    <g
                      id="Icons"
                      stroke="none"
                      strokeWidth={1}
